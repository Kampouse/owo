...
const buttonVariants = cva(
  "inline-flex items-center no-underline justify-center md:whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-300",
  {
    variants: {
      variant: {
        ...
        ghost: "hover:bg-gray-100/10 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50",
      ...
      size: {
        ...
        xl: "h-20 rounded-md px-12 text-lg",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
